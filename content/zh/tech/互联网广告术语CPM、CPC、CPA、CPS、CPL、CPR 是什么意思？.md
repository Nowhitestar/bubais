...
#### 8. OCPC（Optimized Cost per Click），每次点击优化成本
按转化目标智能出价，即经过“优化”后的 CPC，是一种较新的广告投放方式，可以帮助广告主控制转化成本，提高转化量。也就是系统会在广告主的出价基础上，基于多维度、实时反馈以及历史积累的海量数据，并根据预估的转化率以及竞争环境智能化的动态调整出价，进而优化广告排序，帮助广告主竞得最适合的流量，并降低转化成本。
