...
So what is trustless? John Adler and Mikerah Quintyne-Collins explain in their [research paper](https://arxiv.org/pdf/1904.06441.pdf) that "*a blockchain system is trustless if and only if its state (i.e., all its state elements) is both valid and secure, a blockchain system is de-trusted. *"
